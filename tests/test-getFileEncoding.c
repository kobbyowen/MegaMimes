...
void getMegaMimeFileEnc(void* ignored)
{
  ...
  assert_string_equal(getMegaTextFileEncoding("tests/data/utf8.txt"), "UTF-8") ;
  assert_string_equal(getMegaTextFileEncoding("tests/data/utf8bom-enc.txt"), "UTF-8") ;
  ...
  assert_string_equal(getMegaTextFileEncoding("tests/data/MegaMimeTypes.json"), "UTF-8") ;
	...
	assert_string_equal(getMegaTextFileEncoding("tests/data/MegaMimeTypes.py"), "UTF-8") ;
	
  assert_llong_equal(isTextFile("tests/data/utf8.txt"), true) ;
  assert_llong_equal(isTextFile("tests/data/utf8bom-enc.txt"), true) ;
